...
| d_observe_llm_v2 | panic_rebound_probe | T+1 | 22/15 | 38% | -0.72% | 55% (N=11) | 64% (N=11) | mixed_intraday_path | preliminary_conflict |
...
| d_observe_llm_v2 | risk_off_confirm | T+10 | 10/13 | 48% | +1.47% | 40% (N=5) | 50% (N=6) | mixed_intraday_path | mixed |
