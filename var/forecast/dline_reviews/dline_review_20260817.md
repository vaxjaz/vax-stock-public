...
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| d_observe_llm_v2 | breakdown_confirm | T+1 | 58/83 | 50% | +0.42% | 50% (N=38) | 59% (N=41) | mixed_intraday_path | mixed |
| d_observe_llm_v2 | breakdown_confirm | T+10 | 55/55 | 62% | +6.23% | 50% (N=36) | 61% (N=38) | mixed_intraday_path | stable_support |
...
| d_observe_llm_v2 | breakdown_confirm | T+5 | 56/67 | 53% | +3.50% | 49% (N=37) | 59% (N=39) | mixed_intraday_path | mixed |
| d_observe_llm_v2 | breakout_confirm | T+1 | 6/14 | 35% | -3.46% | 100% (N=2) | 100% (N=2) | insufficient_intraday_path | preliminary_conflict |
| d_observe_llm_v2 | breakout_confirm | T+10 | 5/8 | 38% | -13.96% | 100% (N=1) | 100% (N=1) | insufficient_intraday_path | preliminary_conflict |
| d_observe_llm_v2 | breakout_confirm | T+30 | 3/0 | 0% | 待验证 | 待验证 (N=0) | 待验证 (N=0) | insufficient_intraday_path | insufficient_counterfactual |
| d_observe_llm_v2 | breakout_confirm | T+5 | 6/12 | 39% | -8.00% | 100% (N=2) | 100% (N=2) | insufficient_intraday_path | preliminary_conflict |
| d_observe_llm_v2 | failed_breakout | T+1 | 5/6 | 36% | -1.68% | 50% (N=4) | 50% (N=4) | insufficient_intraday_path | preliminary_conflict |
...
| d_observe_llm_v2 | reclaim_confirm | T+1 | 27/100 | 53% | -1.39% | 40% (N=15) | 67% (N=15) | preliminary_trigger_early | mixed |
| d_observe_llm_v2 | reclaim_confirm | T+10 | 22/79 | 53% | -5.33% | 50% (N=10) | 70% (N=10) | mixed_intraday_path | mixed |
| d_observe_llm_v2 | reclaim_confirm | T+30 | 1/0 | 0% | 待验证 | 待验证 (N=0) | 待验证 (N=0) | insufficient_intraday_path | insufficient_counterfactual |
| d_observe_llm_v2 | reclaim_confirm | T+5 | 24/85 | 50% | -3.50% | 50% (N=12) | 75% (N=12) | mixed_intraday_path | mixed |
| d_observe_llm_v2 | risk_off_confirm | T+1 | 9/6 | 40% | -1.51% | 25% (N=4) | 40% (N=5) | insufficient_intraday_path | preliminary_conflict |
| d_observe_llm_v2 | risk_off_confirm | T+10 | 8/5 | 69% | +5.85% | 25% (N=4) | 50% (N=4) | insufficient_intraday_path | preliminary_support |
| d_observe_llm_v2 | risk_off_confirm | T+5 | 9/5 | 57% | +4.47% | 25% (N=4) | 40% (N=5) | insufficient_intraday_path | mixed |
