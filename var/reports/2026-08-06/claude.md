...
- trade_date: 20260806
- generated_at: 2026-08-07 05:00:10
- freshness: ready
...
- 动态分组: **written** | stocks=41, memberships=4314
- 结果关联: **written** | samples_ready=19288, samples_written=1218
- AI锚概率预测: **estimated**
...
|---|---|---:|---|---:|---:|---|
| T+1 | down | 27.8% | negative_excess | 29.5% | 15 | estimated_not_oos_validated |
| T+5 | down | 20.7% | negative_excess | 26.9% | 14 | estimated_not_oos_validated |
| T+20 | down | 3.8% | negative_excess | 3.8% | 5 | estimated_not_oos_validated |
...
- AI算力: available=True | position_ceiling=减档 (单否决, 不加且高位减) | source_date=20260807（与报告交易日不一致）
