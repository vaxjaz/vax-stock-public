...
- trade_date: 20260729
- generated_at: 2026-07-30 05:00:15
- freshness: ready
- universe: 持仓5 / 观察池36 / 合计41

## 市场事实

- regime: **panic** | raw=momentum | 原因=未触发 panic/value 阈值,按现行规则默认 momentum
- 全市场: 涨4253 / 跌1215 / 涨停89 / 跌停17
...
- 动态分组: **written** | stocks=41, memberships=2524
- 结果关联: **written** | samples_ready=12549, samples_written=1004
- AI锚概率预测: **estimated**
...
|---|---|---:|---|---:|---:|---|
| T+1 | down | 24.1% | negative_excess | 26.3% | 13 | estimated_not_oos_validated |
| T+5 | down | 12.0% | negative_excess | 20.8% | 9 | estimated_not_oos_validated |
| T+20 | ABSTAIN | 10.2% | ABSTAIN | 10.2% | 2 | sparse_estimate |
...
- AI算力: available=True | position_ceiling=减档 (单否决, 不加且高位减) | source_date=20260730（与报告交易日不一致）
