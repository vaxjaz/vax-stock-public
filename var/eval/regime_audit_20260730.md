...
- reason: limit_down_count=112 > 50
...
| field | value |
|---|---:|
| limit_down_count | 112 |
| limit_down_threshold | 50 |
| sh_change_pct | -0.621 |
| cyb_change_pct | -3.9684 |
| kc50_change_pct | -5.3804 |
| growth_avg_change_pct | -4.6744 |
| growth_minus_sh_pct | -4.0534 |
| sh_minus_growth_pct | 4.0534 |
